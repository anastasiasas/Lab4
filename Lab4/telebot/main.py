...
bot = telebot.TeleBot('2111798061:AAGSJfnEvHgInIK-h51lv9T_Fbj4522413A')

conn = psycopg2.connect(database="predmety", user="postgres", password="12345", host="localhost", port="5432")
cursor = conn.cursor()
